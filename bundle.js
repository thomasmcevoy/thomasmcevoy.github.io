...
/***/ function(module, exports, __webpack_require__) {
	...
	var _touchEvents = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.initializeTouchEvents = initializeTouchEvents;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $songs = $playlist.find('.song');
	var $playButton = (0, _jquery2.default)('#play');
	var $pauseButton = (0, _jquery2.default)('#pause');
	var $nextButton = (0, _jquery2.default)('#next');
	var $previousButton = (0, _jquery2.default)('#previous');
	var $seekBar = (0, _jquery2.default)('#seekBar');
	var $durationElement = (0, _jquery2.default)('#duration');
	var $currentTimeElement = (0, _jquery2.default)('#currentTime');

	// Methods
	function timeFilter(seconds) {
	  var m = Math.floor(seconds / 60);
	  var ss = Math.floor(seconds - m * 60);
	...
	function initializePlayer() {
	  _format = Modernizr.audio.mp3 ? 'mp3' : Modernizr.audio.ogg ? 'ogg' : undefined;

	  if (!_format) {
	    (0, _jquery2.default)('html').addClass('no-audio');
	    return;
	  }
	...
	function play(event) {
	  ...
	  var $current = $songs.eq(_currentTrack);

	  if (event) {
	    var $target = (0, _jquery2.default)(event.target);
	    if ($target.is('.song')) {
	      var track = $target.attr('data-track');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.initializeExpandables = initializeExpandables;
	...
	function initializeExpandables() {
	  ...
	  if (window.matchMedia('(min-width: 750px)').matches) {
	    (0, _jquery2.default)('#about').find('.expandable').removeClass('expandable');
	  }

	  var $expandables = (0, _jquery2.default)('.expandable');

	  for (var i = 0; i < $expandables.length; i++) {
	    var $btn = (0, _jquery2.default)('<button>SHOW MORE</button>');
	    var $exp = $expandables.eq(i);
	...
	function toggleExpand(event) {
	  var $btn = (0, _jquery2.default)(event.target);
	  var $exp = $btn.prev();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $modal = (0, _jquery2.default)('<div id="modal"></div>');
	var $overlay = (0, _jquery2.default)('<div id="overlay"></div>');
	var $content = (0, _jquery2.default)('<div id="content"></div>');
	...
	function initializeModal() {
	  ...
	  (0, _jquery2.default)('body').append($overlay, $modal);
	}
